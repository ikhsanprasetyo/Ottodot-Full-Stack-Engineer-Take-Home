...
- **2026-09-25**: Fixed quick demo login credentials state closure bug in [`page.tsx`](file:///c:/Project/Web/Ottodot%20Full-Stack%20Engineer%20Take-Home/client/app/page.tsx) and active parent matching logic in [`dashboard/page.tsx`](file:///c:/Project/Web/Ottodot%20Full-Stack%20Engineer%20Take-Home/client/app/dashboard/page.tsx). Selecting "Parent 2: Sarah Jenkins (Ethan)" during login now immediately logs in as Sarah Jenkins and auto-selects Ethan on the dashboard.
